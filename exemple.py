...
class Main_Window():
    ...
    def openinventorywindow(self):
        ...
        w = iw.InventoryWindow(toplevel=True,player_dic=self.player_dic,inventory_dic=self.inventory_dic,attribut_dic=self.attribut_dic,function = self.reload_everything,rel_x=50,rel_y=50)
